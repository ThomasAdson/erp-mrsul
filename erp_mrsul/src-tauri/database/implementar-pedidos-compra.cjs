    ...
    if (pedidosCount.count === 0) {
        ...
        if (fornecedores.length === 0) {
            ...
            db.exec(`
                ...
                ('FORN003', 'Distribuidora Metais & Cia', 'Metais e Cia Distribuidora Ltda', '34.567.890/0001-34', 'Rua dos Metais, 789', 'Belo Horizonte', 'MG', '(31) 3567-8901', 'vendas@metaiscia.com.br', 'Especialista em metais e ligas');
            `);
        ...
        if (materiais.length === 0) {
            ...
            db.exec(`
                ...
                ('MAT003', 'CAT001', 'TR-50x2', 'Tubo Redondo 50mm x 2mm', 'Aço Carbono', 'M', 'TR-50x2-M', 'Tubo redondo de aço 50mm diâmetro x 2mm espessura', 18.75, 'M'),
                ('MAT004', 'CAT002', 'EL-E6013-3.25', 'Eletrodo E6013 3,25mm', 'Eletrodo revestido', 'KG', 'EL-E6013-3.25-KG', 'Eletrodo para solda E6013 diâmetro 3,25mm', 12.80, 'KG'),
                ('MAT005', 'CAT003', 'DC-4.5', 'Disco de Corte 4.1/2"', 'Óxido de Alumínio', 'UN', 'DC-4.5-UN', 'Disco de corte para aço 4.1/2 polegadas', 4.50, 'UN');
            `);
        ...
        stmtItem.run(pedidoId, 'MAT001', 100, 8.50, 'Chapa para estrutura principal');
        stmtItem.run(pedidoId, 'MAT002', 20, 25.30, 'Perfis para reforço');
        stmtItem.run(pedidoId, 'MAT003', 15, 18.75, 'Tubos para acabamento');
